...
//   const isFold = width >= 600;

//   // 🔥 Fix FlatList on fold / rotate
//   useEffect(() => {
...
//         resizeMode="contain"
//         style={{
//           width: isFold ? width * 0.6 : width * 0.9,
//           height: height * (isFold ? 0.30 : 0.4),
//           marginTop: 30,
//         }}
//       />

//       <View style={{ paddingHorizontal: 24 }}>
//         <Text style={[styles.title, { fontSize: isFold ? 34 : 38 }]}>
//           {item.title}
//         </Text>
...
//             <View
//               key={i}
//               style={[styles.dot, i === currentIndex && styles.active]}
//             />
//           ))}
//         </View>
...
//             disabled={!slide.buttons.includes('Skip')}
//             style={[
//               styles.skip,
//               !slide.buttons.includes('Skip') && { opacity: 0 },
//             ]}
//           >
//             <Text style={styles.skipText}>Skip</Text>
//           </TouchableOpacity>
...
//             style={styles.next}
//             onPress={() => {
//               if (slide.buttons.includes('Next')) {
//                 flatListRef.current.scrollToIndex({ index: currentIndex + 1 });
//               } else if (slide.buttons.includes('Get Started')) {
//                 flatListRef.current.scrollToIndex({ index: currentIndex + 1 });
//               } else {
...
//           >
//             <Text style={styles.nextText}>
//               {slide.buttons.includes('Next')
//                 ? 'Next'
//                 : slide.buttons.includes('Get Started')
//                 ? 'Get Started'
//                 : 'Log in / Sign up'}
//             </Text>
//           </TouchableOpacity>
...
//   title2: { fontWeight: '800', fontSize: scale(24), marginTop: -6 },
//   subtitle: { marginTop: scale(10), fontSize: scale(16), color: '#444' },
...
//     alignItems: 'center',
//   },
//   skipText: { color: '#1C9C48', fontWeight: '600', fontSize: scale(12) },
//   nextText: { color: '#fff', fontWeight: '600' , fontSize: scale(12)},
// });
  ...
  const renderSlide = ({ item }) => (
    <View style={[styles.slide, { width }]}>
      <Image
        ...
        style={{
          width: isFold ? width * 0.6 : width * 0.9,
          height: height * (isFold ? 0.32 : 0.42),
      ...
      <View style={styles.textWrap}>
        <Text
          style={[
            styles.title,
            { fontSize: responsiveFontSize(isFold ? 3.2 : 3.6) },
          ]}
        >
          {item.title}
        </Text>
        ...
        {item.title2 && (
          <Text
            style={[
              styles.title2,
              { fontSize: responsiveFontSize(isFold ? 2.6 : 2.8) },
            ]}
          >
            {item.title2}
          </Text>
        ...
        <View style={styles.buttons}>
          <TouchableOpacity
            ...
            style={[
              styles.skip,
              {
                width: isFold ? width * 0.25 : width * 0.42,
                opacity: slide.buttons.includes('Skip') ? 1 : 0,
              },
            ]}
          >
            <Text style={styles.skipText}>Skip</Text>
